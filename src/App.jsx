...
function HomePage() {
  return (
    <>
      ...
      <main className="relative min-h-screen px-6 py-16 text-white bg-gradient-to-br from-[#d2ecf9] to-[#d3edfa]">
        {/* Pattern overlay */}
        <div
        ...
        <section className="relative max-w-4xl mx-auto text-center bg-white bg-opacity-20 p-10 rounded-lg shadow-lg backdrop-blur-sm z-10">
          ...
          <div className="mb-8 text-sm text-white/70 max-w-md mx-auto">
            Curious how AI fits into your operations? <Link to="/contact" className="underline font-semibold">Book your free strategy session now.</Link>
          </div>

          <div className="mb-12 flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/contact"
              className="inline-block rounded-2xl bg-[#3787b9] px-6 py-3 font-semibold shadow hover:bg-[#2f6e99] transition"
            >
        ...
        {/* Placeholder for other sections to follow */}
      </main>
    </>
  );
}
